...
public class Enchant extends Quest
{
	...
	private final static int itemRequiredArmor = 0;
	
	// Item required to enchant weapon +1
	private final static int itemRequiredWeapon = 0;
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if (event.equals("enchantHelmet1") || event.equals("enchantHelmet10") || event.equals("enchantHelmet50"))
		{
			...
			{
				case "enchantHelmet1":
					htmlText = enchant(enchantType, player, armorType, itemRequiredArmor, itemRequiredCount);
					break;
				case "enchantHelmet10":
					htmlText = enchant10(enchantType, player, armorType, itemRequiredArmor, itemRequiredCount);
					break;
				case "enchantHelmet50":
					htmlText = enchant50(enchantType, player, armorType, itemRequiredArmor, itemRequiredCount);
					break;
		...
		else if (event.equals("enchantWeapon1") || event.equals("enchantWeapon10") || event.equals("enchantWeapon50"))
		{
			...
			{
				case "enchantWeapon1":
					htmlText = enchant(enchantType, player, armorType, itemRequiredWeapon, itemRequiredCount);
					break;
				case "enchantWeapon10":
					htmlText = enchant10(enchantType, player, armorType, itemRequiredWeapon, itemRequiredCount);
					break;
				case "enchantWeapon50":
					htmlText = enchant50(enchantType, player, armorType, itemRequiredWeapon, itemRequiredCount);
					break;
